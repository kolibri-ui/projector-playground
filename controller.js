...
import {Attribute, VALID, VALUE, VISIBILITY} from "./presentationModel.js";
import {ObservableList} from "./observable.js";

export {Controller, TestView}
...
const TestView = (controller, rootElement) => {

    const render = () => playground(controller, rootElement)
    controller.onLoginAdd(render)
